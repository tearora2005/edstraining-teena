...
const PAGE_TEMPLATE = {
  name: 'article-detail',
  description: 'Article detail page: hero header with title and featured image followed by long-form body content sections',
  urls: [
  ...
  blocks: [
    { name: 'hero', instances: ['#main-content > section.section:nth-of-type(1) > div.container > div.grid-layout'] },
  ],
  sections: [
